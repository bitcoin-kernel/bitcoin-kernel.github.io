...
<style>
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}
  ...
  .how{margin:2.6rem 0 0}
  .how h2{font-size:1.2rem;letter-spacing:-.3px;margin:0 0 .8rem}
  .how ol{margin:0;padding-left:1.3rem;color:var(--mut);font-size:.96rem}
  .how li{margin:.55rem 0;line-height:1.55}.how b{color:var(--fg)}
...
<div class="wrap">
  ...
  <section class="how">
    <h2>How it works</h2>
    <ol>
      <li><b>Real test vectors.</b> <a href="${CORE_TESTS}">Bitcoin Core's own script vectors</a>, real mainnet headers, real difficulty retargets, a real block and real inclusion proofs.</li>
      <li><b>An independent checker.</b> bitcoin-kernel is a fresh re-implementation of Bitcoin's consensus rules, sharing no code with Bitcoin Core.</li>
      <li><b>Run on your machine.</b> The page runs every vector through it in your browser, with no server and nothing fetched at runtime.</li>
      <li><b>A green check means it agrees.</b> bitcoin-kernel got the same answer the network does. The mainnet ones you can verify on any block explorer.</li>
    </ol>
  </section>
</div>
